...
class Sender:
    ...
    def encrypt_proof_for_recipient(
        self, proof: dict, reception_commitment: bytes, metadata=None
    ) -> dict:
        """
        Encrypt proof for a specific recipient using commitment-based routing.

        Args:
            proof: The ZK proof to encrypt
            reception_commitment: The recipient's reception commitment
