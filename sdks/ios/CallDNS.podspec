Pod::Spec.new do |spec|
  ...
  spec.description  = <<-DESC
    CallDNS iOS SDK provides zero-knowledge proof verification for incoming calls
  ...
  spec.homepage     = "https://github.com/dipankar/calldns"
  ...
  spec.source       = { :git => "https://github.com/dipankar/calldns.git", :tag => "#{spec.version}" }
  spec.source_files = "sdks/ios/Sources/CallDNS/**/*.{swift,h,m}"
  ...
  spec.test_spec 'Tests' do |test_spec|
    test_spec.source_files = 'sdks/ios/Tests/CallDNSTests/**/*.{swift}'
  end
end