...
class TestWebService(unittest.TestCase):
    ...
    def test_register_commitment(self):
        ...
        payload = {"session_id": "test_session_123", "public_key": "test_public_key"}
    ...
    def test_lookup_commitment(self):
        ...
        payload = {"session_id": "test_session_lookup", "public_key": "test_key"}

        reg_response = self.app.post(
            "/commitments/register",
            data=json.dumps(payload),
            content_type="application/json",
        )
    ...
    def test_verify_proof(self):
        ...
        response = self.app.post(
            "/proofs/verify", data=json.dumps(payload), content_type="application/json"
        )
        self.assertEqual(response.status_code, 200)
    ...
    def test_invalid_request_handling(self):
        ...
        # Test missing data
        response = self.app.post(
            "/proofs/verify", data=json.dumps({}), content_type="application/json"
        )
