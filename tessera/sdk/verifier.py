...
Handles proof verification on recipient device with commitment management and traffic privacy.
"""
...
class Verifier:
    """Handles proof verification on recipient device."""
    ...
    def verify_encrypted_call_proof(self, encrypted_proof_data: dict) -> bool:
        ...
        # Decode base64 data
        try:
            bloom_fingerprint = base64.b64decode(
                encrypted_proof_data["bloom_fingerprint"]
            )
        ...
        if not self.commitment_manager.has_commitment_matching_fingerprint(
            bloom_fingerprint
        ):
        ...
        for comm in self.commitment_manager.commitments:
            ...
            test_fingerprint = self.commitment_manager.generate_bloom_fingerprint(
                comm, timestamp
            )
